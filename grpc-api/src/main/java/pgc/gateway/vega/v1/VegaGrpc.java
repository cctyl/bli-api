...
public final class VegaGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pgc.gateway.vega.v1.VegaFrame,
      pgc.gateway.vega.v1.VegaFrame> getCreateTunnelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateTunnel",
      requestType = pgc.gateway.vega.v1.VegaFrame.class,
      responseType = pgc.gateway.vega.v1.VegaFrame.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<pgc.gateway.vega.v1.VegaFrame,
      pgc.gateway.vega.v1.VegaFrame> getCreateTunnelMethod() {
    io.grpc.MethodDescriptor<pgc.gateway.vega.v1.VegaFrame, pgc.gateway.vega.v1.VegaFrame> getCreateTunnelMethod;
      ...
      synchronized (VegaGrpc.class) {
        if ((getCreateTunnelMethod = VegaGrpc.getCreateTunnelMethod) == null) {
          VegaGrpc.getCreateTunnelMethod = getCreateTunnelMethod =
              io.grpc.MethodDescriptor.<pgc.gateway.vega.v1.VegaFrame, pgc.gateway.vega.v1.VegaFrame>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateTunnel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pgc.gateway.vega.v1.VegaFrame.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createTunnel(pgc.gateway.vega.v1.VegaFrame request,
        io.grpc.stub.StreamObserver<pgc.gateway.vega.v1.VegaFrame> responseObserver) {
  ...
  public static final class VegaStub
    ...
    /**
     */
    public void createTunnel(pgc.gateway.vega.v1.VegaFrame request,
        io.grpc.stub.StreamObserver<pgc.gateway.vega.v1.VegaFrame> responseObserver) {
  ...
  public static final class VegaBlockingStub
    ...
    /**
     */
    public pgc.gateway.vega.v1.VegaFrame createTunnel(pgc.gateway.vega.v1.VegaFrame request) {
  ...
  public static final class VegaFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pgc.gateway.vega.v1.VegaFrame> createTunnel(
        pgc.gateway.vega.v1.VegaFrame request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_TUNNEL:
          serviceImpl.createTunnel((pgc.gateway.vega.v1.VegaFrame) request,
              (io.grpc.stub.StreamObserver<pgc.gateway.vega.v1.VegaFrame>) responseObserver);
          break;
        default:
