...
public final class PremiereGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq,
      bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> getStatusMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Status",
      requestType = bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq.class,
      responseType = bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq,
      bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> getStatusMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq, bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> getStatusMethod;
      ...
      synchronized (PremiereGrpc.class) {
        if ((getStatusMethod = PremiereGrpc.getStatusMethod) == null) {
          PremiereGrpc.getStatusMethod = getStatusMethod =
              io.grpc.MethodDescriptor.<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq, bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Status"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void status(bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> responseObserver) {
  ...
  public static final class PremiereStub
     ...
     * </pre>
     */
    public void status(bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> responseObserver) {
  ...
  public static final class PremiereBlockingStub
     ...
     * </pre>
     */
    public bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply status(bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq request) {
  ...
  public static final class PremiereFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply> status(
        bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STATUS:
          serviceImpl.status((bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReq,
              bilibili.pgc.service.premiere.v1.PremiereRpcProto.PremiereStatusReply>(
  ...
  private static abstract class PremiereBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.pgc.service.premiere.v1.PremiereRpcProto.getDescriptor();
    }
