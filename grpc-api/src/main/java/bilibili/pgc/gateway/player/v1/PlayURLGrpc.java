...
public final class PlayURLGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.PlayViewReq,
      bilibili.pgc.gateway.player.v1.PlayViewReply> getPlayViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlayView",
      requestType = bilibili.pgc.gateway.player.v1.PlayViewReq.class,
      responseType = bilibili.pgc.gateway.player.v1.PlayViewReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.PlayViewReq,
      bilibili.pgc.gateway.player.v1.PlayViewReply> getPlayViewMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.PlayViewReq, bilibili.pgc.gateway.player.v1.PlayViewReply> getPlayViewMethod;
      ...
      synchronized (PlayURLGrpc.class) {
        if ((getPlayViewMethod = PlayURLGrpc.getPlayViewMethod) == null) {
          PlayURLGrpc.getPlayViewMethod = getPlayViewMethod =
              io.grpc.MethodDescriptor.<bilibili.pgc.gateway.player.v1.PlayViewReq, bilibili.pgc.gateway.player.v1.PlayViewReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlayView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.PlayViewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.PlayViewReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.ProjectReq,
      bilibili.pgc.gateway.player.v1.ProjectReply> getProjectMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Project",
      requestType = bilibili.pgc.gateway.player.v1.ProjectReq.class,
      responseType = bilibili.pgc.gateway.player.v1.ProjectReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.ProjectReq,
      bilibili.pgc.gateway.player.v1.ProjectReply> getProjectMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.ProjectReq, bilibili.pgc.gateway.player.v1.ProjectReply> getProjectMethod;
    if ((getProjectMethod = PlayURLGrpc.getProjectMethod) == null) {
      synchronized (PlayURLGrpc.class) {
        if ((getProjectMethod = PlayURLGrpc.getProjectMethod) == null) {
          PlayURLGrpc.getProjectMethod = getProjectMethod =
              io.grpc.MethodDescriptor.<bilibili.pgc.gateway.player.v1.ProjectReq, bilibili.pgc.gateway.player.v1.ProjectReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Project"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.ProjectReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.ProjectReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.LivePlayViewReq,
      bilibili.pgc.gateway.player.v1.LivePlayViewReply> getLivePlayViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "LivePlayView",
      requestType = bilibili.pgc.gateway.player.v1.LivePlayViewReq.class,
      responseType = bilibili.pgc.gateway.player.v1.LivePlayViewReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.LivePlayViewReq,
      bilibili.pgc.gateway.player.v1.LivePlayViewReply> getLivePlayViewMethod() {
    io.grpc.MethodDescriptor<bilibili.pgc.gateway.player.v1.LivePlayViewReq, bilibili.pgc.gateway.player.v1.LivePlayViewReply> getLivePlayViewMethod;
    if ((getLivePlayViewMethod = PlayURLGrpc.getLivePlayViewMethod) == null) {
      synchronized (PlayURLGrpc.class) {
        if ((getLivePlayViewMethod = PlayURLGrpc.getLivePlayViewMethod) == null) {
          PlayURLGrpc.getLivePlayViewMethod = getLivePlayViewMethod =
              io.grpc.MethodDescriptor.<bilibili.pgc.gateway.player.v1.LivePlayViewReq, bilibili.pgc.gateway.player.v1.LivePlayViewReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "LivePlayView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.LivePlayViewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.pgc.gateway.player.v1.LivePlayViewReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void playView(bilibili.pgc.gateway.player.v1.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.PlayViewReply> responseObserver) {
     ...
     * </pre>
     */
    default void project(bilibili.pgc.gateway.player.v1.ProjectReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.ProjectReply> responseObserver) {
     ...
     * </pre>
     */
    default void livePlayView(bilibili.pgc.gateway.player.v1.LivePlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.LivePlayViewReply> responseObserver) {
  ...
  public static final class PlayURLStub
     ...
     * </pre>
     */
    public void playView(bilibili.pgc.gateway.player.v1.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.PlayViewReply> responseObserver) {
     ...
     * </pre>
     */
    public void project(bilibili.pgc.gateway.player.v1.ProjectReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.ProjectReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
     ...
     * </pre>
     */
    public void livePlayView(bilibili.pgc.gateway.player.v1.LivePlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.LivePlayViewReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PlayURLBlockingStub
     ...
     * </pre>
     */
    public bilibili.pgc.gateway.player.v1.PlayViewReply playView(bilibili.pgc.gateway.player.v1.PlayViewReq request) {
     ...
     * </pre>
     */
    public bilibili.pgc.gateway.player.v1.ProjectReply project(bilibili.pgc.gateway.player.v1.ProjectReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public bilibili.pgc.gateway.player.v1.LivePlayViewReply livePlayView(bilibili.pgc.gateway.player.v1.LivePlayViewReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PlayURLFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.gateway.player.v1.PlayViewReply> playView(
        bilibili.pgc.gateway.player.v1.PlayViewReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.gateway.player.v1.ProjectReply> project(
        bilibili.pgc.gateway.player.v1.ProjectReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.pgc.gateway.player.v1.LivePlayViewReply> livePlayView(
        bilibili.pgc.gateway.player.v1.LivePlayViewReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLAY_VIEW:
          serviceImpl.playView((bilibili.pgc.gateway.player.v1.PlayViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.PlayViewReply>) responseObserver);
          break;
        case METHODID_PROJECT:
          serviceImpl.project((bilibili.pgc.gateway.player.v1.ProjectReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.ProjectReply>) responseObserver);
          break;
        case METHODID_LIVE_PLAY_VIEW:
          serviceImpl.livePlayView((bilibili.pgc.gateway.player.v1.LivePlayViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.pgc.gateway.player.v1.LivePlayViewReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class PlayURLBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.pgc.gateway.player.v1.Playurl.getDescriptor();
    }
