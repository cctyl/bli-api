...
public interface VipInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:bilibili.dynamic.gateway.VipInfo)
   ...
   * @return The label.
   */
  bilibili.dynamic.gateway.VipLabel getLabel();
  /**
   * <pre>
   * 标签
   * </pre>
   ...
   * <code>.bilibili.dynamic.gateway.VipLabel label = 4;</code>
   */
  bilibili.dynamic.gateway.VipLabelOrBuilder getLabelOrBuilder();
