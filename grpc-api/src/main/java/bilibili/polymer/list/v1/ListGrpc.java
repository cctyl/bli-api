...
public final class ListGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.list.v1.FavoriteTabReq,
      bilibili.polymer.list.v1.FavoriteTabReply> getFavoriteTabMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FavoriteTab",
      requestType = bilibili.polymer.list.v1.FavoriteTabReq.class,
      responseType = bilibili.polymer.list.v1.FavoriteTabReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.list.v1.FavoriteTabReq,
      bilibili.polymer.list.v1.FavoriteTabReply> getFavoriteTabMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.list.v1.FavoriteTabReq, bilibili.polymer.list.v1.FavoriteTabReply> getFavoriteTabMethod;
      ...
      synchronized (ListGrpc.class) {
        if ((getFavoriteTabMethod = ListGrpc.getFavoriteTabMethod) == null) {
          ListGrpc.getFavoriteTabMethod = getFavoriteTabMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.list.v1.FavoriteTabReq, bilibili.polymer.list.v1.FavoriteTabReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FavoriteTab"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.list.v1.FavoriteTabReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.list.v1.FavoriteTabReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.list.v1.CheckAccountReq,
      bilibili.polymer.list.v1.CheckAccountReply> getCheckAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckAccount",
      requestType = bilibili.polymer.list.v1.CheckAccountReq.class,
      responseType = bilibili.polymer.list.v1.CheckAccountReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.list.v1.CheckAccountReq,
      bilibili.polymer.list.v1.CheckAccountReply> getCheckAccountMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.list.v1.CheckAccountReq, bilibili.polymer.list.v1.CheckAccountReply> getCheckAccountMethod;
    if ((getCheckAccountMethod = ListGrpc.getCheckAccountMethod) == null) {
      synchronized (ListGrpc.class) {
        if ((getCheckAccountMethod = ListGrpc.getCheckAccountMethod) == null) {
          ListGrpc.getCheckAccountMethod = getCheckAccountMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.list.v1.CheckAccountReq, bilibili.polymer.list.v1.CheckAccountReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.list.v1.CheckAccountReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.list.v1.CheckAccountReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void favoriteTab(bilibili.polymer.list.v1.FavoriteTabReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.FavoriteTabReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFavoriteTabMethod(), responseObserver);
    }

    /**
     */
    default void checkAccount(bilibili.polymer.list.v1.CheckAccountReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.CheckAccountReply> responseObserver) {
  ...
  public static final class ListStub
    ...
    /**
     */
    public void favoriteTab(bilibili.polymer.list.v1.FavoriteTabReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.FavoriteTabReply> responseObserver) {
    ...
    /**
     */
    public void checkAccount(bilibili.polymer.list.v1.CheckAccountReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.CheckAccountReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ListBlockingStub
    ...
    /**
     */
    public bilibili.polymer.list.v1.FavoriteTabReply favoriteTab(bilibili.polymer.list.v1.FavoriteTabReq request) {
    ...
    /**
     */
    public bilibili.polymer.list.v1.CheckAccountReply checkAccount(bilibili.polymer.list.v1.CheckAccountReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ListFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.list.v1.FavoriteTabReply> favoriteTab(
        bilibili.polymer.list.v1.FavoriteTabReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.list.v1.CheckAccountReply> checkAccount(
        bilibili.polymer.list.v1.CheckAccountReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FAVORITE_TAB:
          serviceImpl.favoriteTab((bilibili.polymer.list.v1.FavoriteTabReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.FavoriteTabReply>) responseObserver);
          break;
        case METHODID_CHECK_ACCOUNT:
          serviceImpl.checkAccount((bilibili.polymer.list.v1.CheckAccountReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.list.v1.CheckAccountReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class ListBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.polymer.list.v1.ListOuterClass.getDescriptor();
    }
