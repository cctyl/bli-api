...
public final class ContractGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq,
      com.google.protobuf.Empty> getAddContractMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddContract",
      requestType = bilibili.polymer.contract.v1.AddContractReq.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq,
      com.google.protobuf.Empty> getAddContractMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq, com.google.protobuf.Empty> getAddContractMethod;
      ...
      synchronized (ContractGrpc.class) {
        if ((getAddContractMethod = ContractGrpc.getAddContractMethod) == null) {
          ContractGrpc.getAddContractMethod = getAddContractMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.contract.v1.AddContractReq, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AddContract"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.contract.v1.AddContractReq.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq,
      bilibili.polymer.contract.v1.AddContractReply> getAddContractV2Method;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AddContractV2",
      requestType = bilibili.polymer.contract.v1.AddContractReq.class,
      responseType = bilibili.polymer.contract.v1.AddContractReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq,
      bilibili.polymer.contract.v1.AddContractReply> getAddContractV2Method() {
    io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.AddContractReq, bilibili.polymer.contract.v1.AddContractReply> getAddContractV2Method;
      ...
      synchronized (ContractGrpc.class) {
        if ((getAddContractV2Method = ContractGrpc.getAddContractV2Method) == null) {
          ContractGrpc.getAddContractV2Method = getAddContractV2Method =
              io.grpc.MethodDescriptor.<bilibili.polymer.contract.v1.AddContractReq, bilibili.polymer.contract.v1.AddContractReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.contract.v1.AddContractReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.contract.v1.AddContractReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.ContractConfigReq,
      bilibili.polymer.contract.v1.ContractConfigReply> getContractConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ContractConfig",
      requestType = bilibili.polymer.contract.v1.ContractConfigReq.class,
      responseType = bilibili.polymer.contract.v1.ContractConfigReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.ContractConfigReq,
      bilibili.polymer.contract.v1.ContractConfigReply> getContractConfigMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.contract.v1.ContractConfigReq, bilibili.polymer.contract.v1.ContractConfigReply> getContractConfigMethod;
      ...
      synchronized (ContractGrpc.class) {
        if ((getContractConfigMethod = ContractGrpc.getContractConfigMethod) == null) {
          ContractGrpc.getContractConfigMethod = getContractConfigMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.contract.v1.ContractConfigReq, bilibili.polymer.contract.v1.ContractConfigReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ContractConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.contract.v1.ContractConfigReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.contract.v1.ContractConfigReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addContract(bilibili.polymer.contract.v1.AddContractReq request,
    ...
    /**
     */
    default void addContractV2(bilibili.polymer.contract.v1.AddContractReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.AddContractReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddContractV2Method(), responseObserver);
    }

    /**
     */
    default void contractConfig(bilibili.polymer.contract.v1.ContractConfigReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.ContractConfigReply> responseObserver) {
  ...
  public static final class ContractStub
    ...
    /**
     */
    public void addContract(bilibili.polymer.contract.v1.AddContractReq request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
    ...
    /**
     */
    public void addContractV2(bilibili.polymer.contract.v1.AddContractReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.AddContractReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void contractConfig(bilibili.polymer.contract.v1.ContractConfigReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.ContractConfigReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ContractBlockingStub
    ...
    /**
     */
    public com.google.protobuf.Empty addContract(bilibili.polymer.contract.v1.AddContractReq request) {
    ...
    /**
     */
    public bilibili.polymer.contract.v1.AddContractReply addContractV2(bilibili.polymer.contract.v1.AddContractReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public bilibili.polymer.contract.v1.ContractConfigReply contractConfig(bilibili.polymer.contract.v1.ContractConfigReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ContractFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> addContract(
        bilibili.polymer.contract.v1.AddContractReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.contract.v1.AddContractReply> addContractV2(
        bilibili.polymer.contract.v1.AddContractReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.contract.v1.ContractConfigReply> contractConfig(
        bilibili.polymer.contract.v1.ContractConfigReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_CONTRACT:
          serviceImpl.addContract((bilibili.polymer.contract.v1.AddContractReq) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_ADD_CONTRACT_V2:
          serviceImpl.addContractV2((bilibili.polymer.contract.v1.AddContractReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.AddContractReply>) responseObserver);
          break;
        case METHODID_CONTRACT_CONFIG:
          serviceImpl.contractConfig((bilibili.polymer.contract.v1.ContractConfigReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.contract.v1.ContractConfigReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class ContractBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.polymer.contract.v1.ContractOuterClass.getDescriptor();
    }
