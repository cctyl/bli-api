...
public final class AntiHarassmentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq,
      bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> getStoreAntiHarassmentSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StoreAntiHarassmentSettings",
      requestType = bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq.class,
      responseType = bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq,
      bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> getStoreAntiHarassmentSettingsMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq, bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> getStoreAntiHarassmentSettingsMethod;
      ...
      synchronized (AntiHarassmentServiceGrpc.class) {
        if ((getStoreAntiHarassmentSettingsMethod = AntiHarassmentServiceGrpc.getStoreAntiHarassmentSettingsMethod) == null) {
          AntiHarassmentServiceGrpc.getStoreAntiHarassmentSettingsMethod = getStoreAntiHarassmentSettingsMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq, bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StoreAntiHarassmentSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq,
      bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> getLoadAntiHarassmentSettingsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "LoadAntiHarassmentSettings",
      requestType = bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq.class,
      responseType = bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq,
      bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> getLoadAntiHarassmentSettingsMethod() {
    io.grpc.MethodDescriptor<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq, bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> getLoadAntiHarassmentSettingsMethod;
      ...
      synchronized (AntiHarassmentServiceGrpc.class) {
        if ((getLoadAntiHarassmentSettingsMethod = AntiHarassmentServiceGrpc.getLoadAntiHarassmentSettingsMethod) == null) {
          AntiHarassmentServiceGrpc.getLoadAntiHarassmentSettingsMethod = getLoadAntiHarassmentSettingsMethod =
              io.grpc.MethodDescriptor.<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq, bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "LoadAntiHarassmentSettings"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void storeAntiHarassmentSettings(bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getStoreAntiHarassmentSettingsMethod(), responseObserver);
    }

    /**
     */
    default void loadAntiHarassmentSettings(bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> responseObserver) {
  ...
  public static final class AntiHarassmentServiceStub
    ...
    /**
     */
    public void storeAntiHarassmentSettings(bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> responseObserver) {
    ...
    /**
     */
    public void loadAntiHarassmentSettings(bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq request,
        io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class AntiHarassmentServiceBlockingStub
    ...
    /**
     */
    public bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp storeAntiHarassmentSettings(bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq request) {
    ...
    /**
     */
    public bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp loadAntiHarassmentSettings(bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AntiHarassmentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp> storeAntiHarassmentSettings(
        bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp> loadAntiHarassmentSettings(
        bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STORE_ANTI_HARASSMENT_SETTINGS:
          serviceImpl.storeAntiHarassmentSettings((bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.StoreAntiHarassmentSettingsRsp>) responseObserver);
          break;
        case METHODID_LOAD_ANTI_HARASSMENT_SETTINGS:
          serviceImpl.loadAntiHarassmentSettings((bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsReq) request,
              (io.grpc.stub.StreamObserver<bilibili.polymer.app.govern.v1.LoadAntiHarassmentSettingsRsp>) responseObserver);
          break;
        default:
  ...
  private static abstract class AntiHarassmentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.polymer.app.govern.v1.Govern.getDescriptor();
    }
