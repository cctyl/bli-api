...
public final class InnerInterfaceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "bilibili.im.interfaces.inner.interfaces.v1.InnerInterface";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist,
      bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> getUpdateListInnMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateListInn",
      requestType = bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist.class,
      responseType = bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist,
      bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> getUpdateListInnMethod() {
    io.grpc.MethodDescriptor<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist, bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> getUpdateListInnMethod;
      ...
      synchronized (InnerInterfaceGrpc.class) {
        if ((getUpdateListInnMethod = InnerInterfaceGrpc.getUpdateListInnMethod) == null) {
          InnerInterfaceGrpc.getUpdateListInnMethod = getUpdateListInnMethod =
              io.grpc.MethodDescriptor.<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist, bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateListInn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void updateListInn(bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist request,
        io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> responseObserver) {
  ...
  public static final class InnerInterfaceStub
    ...
    /**
     */
    public void updateListInn(bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist request,
        io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> responseObserver) {
  ...
  public static final class InnerInterfaceBlockingStub
    ...
    /**
     */
    public bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist updateListInn(bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist request) {
  ...
  public static final class InnerInterfaceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist> updateListInn(
        bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_LIST_INN:
          serviceImpl.updateListInn((bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist) request,
              (io.grpc.stub.StreamObserver<bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.ReqOpBlacklist,
              bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.RspOpBlacklist>(
  ...
  private static abstract class InnerInterfaceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.im.interfaces.inner.interfaces.v1.ApiRpcProto.getDescriptor();
    }
