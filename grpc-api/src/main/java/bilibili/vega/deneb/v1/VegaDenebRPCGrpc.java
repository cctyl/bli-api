...
public final class VegaDenebRPCGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.vega.deneb.v1.MessagePullsReq,
      bilibili.vega.deneb.v1.MessagePullsReply> getMessagePullsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MessagePulls",
      requestType = bilibili.vega.deneb.v1.MessagePullsReq.class,
      responseType = bilibili.vega.deneb.v1.MessagePullsReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.vega.deneb.v1.MessagePullsReq,
      bilibili.vega.deneb.v1.MessagePullsReply> getMessagePullsMethod() {
    io.grpc.MethodDescriptor<bilibili.vega.deneb.v1.MessagePullsReq, bilibili.vega.deneb.v1.MessagePullsReply> getMessagePullsMethod;
      ...
      synchronized (VegaDenebRPCGrpc.class) {
        if ((getMessagePullsMethod = VegaDenebRPCGrpc.getMessagePullsMethod) == null) {
          VegaDenebRPCGrpc.getMessagePullsMethod = getMessagePullsMethod =
              io.grpc.MethodDescriptor.<bilibili.vega.deneb.v1.MessagePullsReq, bilibili.vega.deneb.v1.MessagePullsReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MessagePulls"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.vega.deneb.v1.MessagePullsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.vega.deneb.v1.MessagePullsReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void messagePulls(bilibili.vega.deneb.v1.MessagePullsReq request,
        io.grpc.stub.StreamObserver<bilibili.vega.deneb.v1.MessagePullsReply> responseObserver) {
  ...
  public static final class VegaDenebRPCStub
    ...
    /**
     */
    public void messagePulls(bilibili.vega.deneb.v1.MessagePullsReq request,
        io.grpc.stub.StreamObserver<bilibili.vega.deneb.v1.MessagePullsReply> responseObserver) {
  ...
  public static final class VegaDenebRPCBlockingStub
    ...
    /**
     */
    public bilibili.vega.deneb.v1.MessagePullsReply messagePulls(bilibili.vega.deneb.v1.MessagePullsReq request) {
  ...
  public static final class VegaDenebRPCFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.vega.deneb.v1.MessagePullsReply> messagePulls(
        bilibili.vega.deneb.v1.MessagePullsReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MESSAGE_PULLS:
          serviceImpl.messagePulls((bilibili.vega.deneb.v1.MessagePullsReq) request,
              (io.grpc.stub.StreamObserver<bilibili.vega.deneb.v1.MessagePullsReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class VegaDenebRPCBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.vega.deneb.v1.Deneb.getDescriptor();
    }
