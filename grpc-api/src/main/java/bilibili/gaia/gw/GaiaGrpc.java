...
public final class GaiaGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq,
      bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> getExUploadAppListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExUploadAppList",
      requestType = bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq.class,
      responseType = bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq,
      bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> getExUploadAppListMethod() {
    io.grpc.MethodDescriptor<bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq, bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> getExUploadAppListMethod;
      ...
      synchronized (GaiaGrpc.class) {
        if ((getExUploadAppListMethod = GaiaGrpc.getExUploadAppListMethod) == null) {
          GaiaGrpc.getExUploadAppListMethod = getExUploadAppListMethod =
              io.grpc.MethodDescriptor.<bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq, bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExUploadAppList"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply> getExFetchPublicKeyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExFetchPublicKey",
      requestType = com.google.protobuf.Empty.class,
      responseType = bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply> getExFetchPublicKeyMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply> getExFetchPublicKeyMethod;
      ...
      synchronized (GaiaGrpc.class) {
        if ((getExFetchPublicKeyMethod = GaiaGrpc.getExFetchPublicKeyMethod) == null) {
          GaiaGrpc.getExFetchPublicKeyMethod = getExFetchPublicKeyMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void exUploadAppList(bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq request,
        io.grpc.stub.StreamObserver<bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> responseObserver) {
    ...
    default void exFetchPublicKey(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply> responseObserver) {
  ...
  public static final class GaiaStub
     ...
     * </pre>
     */
    public void exUploadAppList(bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq request,
        io.grpc.stub.StreamObserver<bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> responseObserver) {
  ...
  public static final class GaiaBlockingStub
     ...
     * </pre>
     */
    public bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply exUploadAppList(bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq request) {
     ...
     * </pre>
     */
    public bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply exFetchPublicKey(com.google.protobuf.Empty request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class GaiaFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply> exUploadAppList(
        bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply> exFetchPublicKey(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EX_UPLOAD_APP_LIST:
          serviceImpl.exUploadAppList((bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq) request,
              (io.grpc.stub.StreamObserver<bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply>) responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.gaia.gw.Gw_apiRpcProto.GaiaEncryptMsgReq,
              bilibili.gaia.gw.Gw_apiRpcProto.UploadAppListReply>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              bilibili.gaia.gw.Gw_apiRpcProto.FetchPublicKeyReply>(
  ...
  private static abstract class GaiaBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.gaia.gw.Gw_apiRpcProto.getDescriptor();
    }
