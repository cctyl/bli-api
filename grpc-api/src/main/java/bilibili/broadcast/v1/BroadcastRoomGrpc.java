...
public final class BroadcastRoomGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.broadcast.v1.RoomRpcProto.RoomReq,
      bilibili.broadcast.v1.RoomRpcProto.RoomResp> getEnterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Enter",
      requestType = bilibili.broadcast.v1.RoomRpcProto.RoomReq.class,
      responseType = bilibili.broadcast.v1.RoomRpcProto.RoomResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<bilibili.broadcast.v1.RoomRpcProto.RoomReq,
      bilibili.broadcast.v1.RoomRpcProto.RoomResp> getEnterMethod() {
    io.grpc.MethodDescriptor<bilibili.broadcast.v1.RoomRpcProto.RoomReq, bilibili.broadcast.v1.RoomRpcProto.RoomResp> getEnterMethod;
      ...
      synchronized (BroadcastRoomGrpc.class) {
        if ((getEnterMethod = BroadcastRoomGrpc.getEnterMethod) == null) {
          BroadcastRoomGrpc.getEnterMethod = getEnterMethod =
              io.grpc.MethodDescriptor.<bilibili.broadcast.v1.RoomRpcProto.RoomReq, bilibili.broadcast.v1.RoomRpcProto.RoomResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Enter"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.v1.RoomRpcProto.RoomReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.v1.RoomRpcProto.RoomResp.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<bilibili.broadcast.v1.RoomRpcProto.RoomReq> enter(
        io.grpc.stub.StreamObserver<bilibili.broadcast.v1.RoomRpcProto.RoomResp> responseObserver) {
  ...
  public static final class BroadcastRoomStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<bilibili.broadcast.v1.RoomRpcProto.RoomReq> enter(
        io.grpc.stub.StreamObserver<bilibili.broadcast.v1.RoomRpcProto.RoomResp> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              bilibili.broadcast.v1.RoomRpcProto.RoomReq,
              bilibili.broadcast.v1.RoomRpcProto.RoomResp>(
  ...
  private static abstract class BroadcastRoomBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.broadcast.v1.RoomRpcProto.getDescriptor();
    }
