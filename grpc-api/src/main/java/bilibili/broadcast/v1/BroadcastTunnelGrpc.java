...
public final class BroadcastTunnelGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame,
      bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> getCreateTunnelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateTunnel",
      requestType = bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame.class,
      responseType = bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame,
      bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> getCreateTunnelMethod() {
    io.grpc.MethodDescriptor<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame, bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> getCreateTunnelMethod;
      ...
      synchronized (BroadcastTunnelGrpc.class) {
        if ((getCreateTunnelMethod = BroadcastTunnelGrpc.getCreateTunnelMethod) == null) {
          BroadcastTunnelGrpc.getCreateTunnelMethod = getCreateTunnelMethod =
              io.grpc.MethodDescriptor.<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame, bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateTunnel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> createTunnel(
        io.grpc.stub.StreamObserver<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> responseObserver) {
  ...
  public static final class BroadcastTunnelStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> createTunnel(
        io.grpc.stub.StreamObserver<bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame,
              bilibili.broadcast.v1.BroadcastRpcProto.BroadcastFrame>(
