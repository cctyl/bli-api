...
public final class NativePageGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.main.NativePageEvent> getWatchNotifyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WatchNotify",
      requestType = com.google.protobuf.Empty.class,
      responseType = bilibili.broadcast.message.main.NativePageEvent.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.main.NativePageEvent> getWatchNotifyMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, bilibili.broadcast.message.main.NativePageEvent> getWatchNotifyMethod;
      ...
      synchronized (NativePageGrpc.class) {
        if ((getWatchNotifyMethod = NativePageGrpc.getWatchNotifyMethod) == null) {
          NativePageGrpc.getWatchNotifyMethod = getWatchNotifyMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, bilibili.broadcast.message.main.NativePageEvent>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.message.main.NativePageEvent.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void watchNotify(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<bilibili.broadcast.message.main.NativePageEvent> responseObserver) {
  ...
  public static final class NativePageBlockingStub
    ...
    /**
     */
    public java.util.Iterator<bilibili.broadcast.message.main.NativePageEvent> watchNotify(
  ...
  private static abstract class NativePageBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.broadcast.message.main.Native.getDescriptor();
    }
