...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return bilibili.broadcast.message.main.Dm.internal_static_bilibili_broadcast_message_main_CommandDm_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            bilibili.broadcast.message.main.CommandDm.class, bilibili.broadcast.message.main.CommandDm.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof bilibili.broadcast.message.main.CommandDm)) {
      return super.equals(obj);
    }
    bilibili.broadcast.message.main.CommandDm other = (bilibili.broadcast.message.main.CommandDm) obj;
  ...
  public static bilibili.broadcast.message.main.CommandDm parseFrom(
  ...
  public static bilibili.broadcast.message.main.CommandDm parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static bilibili.broadcast.message.main.CommandDm parseFrom(
  ...
  public static bilibili.broadcast.message.main.CommandDm parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static bilibili.broadcast.message.main.CommandDm parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static bilibili.broadcast.message.main.CommandDm parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(bilibili.broadcast.message.main.CommandDm prototype) {
  ...
  public static final class Builder extends
      ...
      bilibili.broadcast.message.main.CommandDmOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return bilibili.broadcast.message.main.Dm.internal_static_bilibili_broadcast_message_main_CommandDm_descriptor;
    }
    ...
    // Construct using bilibili.broadcast.message.main.CommandDm.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public bilibili.broadcast.message.main.CommandDm getDefaultInstanceForType() {
      return bilibili.broadcast.message.main.CommandDm.getDefaultInstance();
    }

    @java.lang.Override
    public bilibili.broadcast.message.main.CommandDm build() {
      bilibili.broadcast.message.main.CommandDm result = buildPartial();
    ...
    @java.lang.Override
    public bilibili.broadcast.message.main.CommandDm buildPartial() {
      bilibili.broadcast.message.main.CommandDm result = new bilibili.broadcast.message.main.CommandDm(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(bilibili.broadcast.message.main.CommandDm result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof bilibili.broadcast.message.main.CommandDm) {
        return mergeFrom((bilibili.broadcast.message.main.CommandDm)other);
      } else {
    ...
    public Builder mergeFrom(bilibili.broadcast.message.main.CommandDm other) {
      if (other == bilibili.broadcast.message.main.CommandDm.getDefaultInstance()) return this;
      if (other.getId() != 0L) {
        setId(other.getId());
      }
      if (other.getOid() != 0L) {
  ...
  private static final bilibili.broadcast.message.main.CommandDm DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new bilibili.broadcast.message.main.CommandDm();
  }

  public static bilibili.broadcast.message.main.CommandDm getDefaultInstance() {
