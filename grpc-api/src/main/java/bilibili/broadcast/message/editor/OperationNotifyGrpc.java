...
public final class OperationNotifyGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.editor.NotifyRpcProto.Notify> getOperationNotifyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OperationNotify",
      requestType = com.google.protobuf.Empty.class,
      responseType = bilibili.broadcast.message.editor.NotifyRpcProto.Notify.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.editor.NotifyRpcProto.Notify> getOperationNotifyMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, bilibili.broadcast.message.editor.NotifyRpcProto.Notify> getOperationNotifyMethod;
      ...
      synchronized (OperationNotifyGrpc.class) {
        if ((getOperationNotifyMethod = OperationNotifyGrpc.getOperationNotifyMethod) == null) {
          OperationNotifyGrpc.getOperationNotifyMethod = getOperationNotifyMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, bilibili.broadcast.message.editor.NotifyRpcProto.Notify>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.message.editor.NotifyRpcProto.Notify.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void operationNotify(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<bilibili.broadcast.message.editor.NotifyRpcProto.Notify> responseObserver) {
  ...
  public static final class OperationNotifyBlockingStub
    ...
    /**
     */
    public java.util.Iterator<bilibili.broadcast.message.editor.NotifyRpcProto.Notify> operationNotify(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              bilibili.broadcast.message.editor.NotifyRpcProto.Notify>(
  ...
  private static abstract class OperationNotifyBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.broadcast.message.editor.NotifyRpcProto.getDescriptor();
    }
