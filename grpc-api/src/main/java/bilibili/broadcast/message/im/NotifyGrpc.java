...
public final class NotifyGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.im.NotifyRsp> getWatchNotifyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WatchNotify",
      requestType = com.google.protobuf.Empty.class,
      responseType = bilibili.broadcast.message.im.NotifyRsp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.im.NotifyRsp> getWatchNotifyMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, bilibili.broadcast.message.im.NotifyRsp> getWatchNotifyMethod;
      ...
      synchronized (NotifyGrpc.class) {
        if ((getWatchNotifyMethod = NotifyGrpc.getWatchNotifyMethod) == null) {
          NotifyGrpc.getWatchNotifyMethod = getWatchNotifyMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, bilibili.broadcast.message.im.NotifyRsp>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.message.im.NotifyRsp.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void watchNotify(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<bilibili.broadcast.message.im.NotifyRsp> responseObserver) {
  ...
  public static final class NotifyBlockingStub
    ...
    /**
     */
    public java.util.Iterator<bilibili.broadcast.message.im.NotifyRsp> watchNotify(
  ...
  private static abstract class NotifyBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.broadcast.message.im.NotifyOuterClass.getDescriptor();
    }
