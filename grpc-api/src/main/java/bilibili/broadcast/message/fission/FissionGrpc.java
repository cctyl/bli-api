...
public final class FissionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.fission.GameNotifyReply> getGameNotifyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GameNotify",
      requestType = com.google.protobuf.Empty.class,
      responseType = bilibili.broadcast.message.fission.GameNotifyReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      bilibili.broadcast.message.fission.GameNotifyReply> getGameNotifyMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, bilibili.broadcast.message.fission.GameNotifyReply> getGameNotifyMethod;
      ...
      synchronized (FissionGrpc.class) {
        if ((getGameNotifyMethod = FissionGrpc.getGameNotifyMethod) == null) {
          FissionGrpc.getGameNotifyMethod = getGameNotifyMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, bilibili.broadcast.message.fission.GameNotifyReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.broadcast.message.fission.GameNotifyReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void gameNotify(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<bilibili.broadcast.message.fission.GameNotifyReply> responseObserver) {
  ...
  public static final class FissionBlockingStub
    ...
    /**
     */
    public java.util.Iterator<bilibili.broadcast.message.fission.GameNotifyReply> gameNotify(
  ...
  private static abstract class FissionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.broadcast.message.fission.Notify.getDescriptor();
    }
