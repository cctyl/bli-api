...
public final class PlayURLGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.PlayViewReq,
      bilibili.cheese.gateway.player.v1.PlayViewReply> getPlayViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlayView",
      requestType = bilibili.cheese.gateway.player.v1.PlayViewReq.class,
      responseType = bilibili.cheese.gateway.player.v1.PlayViewReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.PlayViewReq,
      bilibili.cheese.gateway.player.v1.PlayViewReply> getPlayViewMethod() {
    io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.PlayViewReq, bilibili.cheese.gateway.player.v1.PlayViewReply> getPlayViewMethod;
      ...
      synchronized (PlayURLGrpc.class) {
        if ((getPlayViewMethod = PlayURLGrpc.getPlayViewMethod) == null) {
          PlayURLGrpc.getPlayViewMethod = getPlayViewMethod =
              io.grpc.MethodDescriptor.<bilibili.cheese.gateway.player.v1.PlayViewReq, bilibili.cheese.gateway.player.v1.PlayViewReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlayView"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.cheese.gateway.player.v1.PlayViewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.cheese.gateway.player.v1.PlayViewReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.ProjectReq,
      bilibili.cheese.gateway.player.v1.ProjectReply> getProjectMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Project",
      requestType = bilibili.cheese.gateway.player.v1.ProjectReq.class,
      responseType = bilibili.cheese.gateway.player.v1.ProjectReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.ProjectReq,
      bilibili.cheese.gateway.player.v1.ProjectReply> getProjectMethod() {
    io.grpc.MethodDescriptor<bilibili.cheese.gateway.player.v1.ProjectReq, bilibili.cheese.gateway.player.v1.ProjectReply> getProjectMethod;
    if ((getProjectMethod = PlayURLGrpc.getProjectMethod) == null) {
      synchronized (PlayURLGrpc.class) {
        if ((getProjectMethod = PlayURLGrpc.getProjectMethod) == null) {
          PlayURLGrpc.getProjectMethod = getProjectMethod =
              io.grpc.MethodDescriptor.<bilibili.cheese.gateway.player.v1.ProjectReq, bilibili.cheese.gateway.player.v1.ProjectReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Project"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.cheese.gateway.player.v1.ProjectReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.cheese.gateway.player.v1.ProjectReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void playView(bilibili.cheese.gateway.player.v1.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.PlayViewReply> responseObserver) {
     ...
     * </pre>
     */
    default void project(bilibili.cheese.gateway.player.v1.ProjectReq request,
        io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.ProjectReply> responseObserver) {
  ...
  public static final class PlayURLStub
     ...
     * </pre>
     */
    public void playView(bilibili.cheese.gateway.player.v1.PlayViewReq request,
        io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.PlayViewReply> responseObserver) {
     ...
     * </pre>
     */
    public void project(bilibili.cheese.gateway.player.v1.ProjectReq request,
        io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.ProjectReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PlayURLBlockingStub
     ...
     * </pre>
     */
    public bilibili.cheese.gateway.player.v1.PlayViewReply playView(bilibili.cheese.gateway.player.v1.PlayViewReq request) {
     ...
     * </pre>
     */
    public bilibili.cheese.gateway.player.v1.ProjectReply project(bilibili.cheese.gateway.player.v1.ProjectReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PlayURLFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.cheese.gateway.player.v1.PlayViewReply> playView(
        bilibili.cheese.gateway.player.v1.PlayViewReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.cheese.gateway.player.v1.ProjectReply> project(
        bilibili.cheese.gateway.player.v1.ProjectReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLAY_VIEW:
          serviceImpl.playView((bilibili.cheese.gateway.player.v1.PlayViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.PlayViewReply>) responseObserver);
          break;
        case METHODID_PROJECT:
          serviceImpl.project((bilibili.cheese.gateway.player.v1.ProjectReq) request,
              (io.grpc.stub.StreamObserver<bilibili.cheese.gateway.player.v1.ProjectReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class PlayURLBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.cheese.gateway.player.v1.Playurl.getDescriptor();
    }
