...
public final class HeartbeatGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.api.player.v1.HeartbeatReq,
      bilibili.api.player.v1.HeartbeatReply> getMobileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Mobile",
      requestType = bilibili.api.player.v1.HeartbeatReq.class,
      responseType = bilibili.api.player.v1.HeartbeatReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.api.player.v1.HeartbeatReq,
      bilibili.api.player.v1.HeartbeatReply> getMobileMethod() {
    io.grpc.MethodDescriptor<bilibili.api.player.v1.HeartbeatReq, bilibili.api.player.v1.HeartbeatReply> getMobileMethod;
      ...
      synchronized (HeartbeatGrpc.class) {
        if ((getMobileMethod = HeartbeatGrpc.getMobileMethod) == null) {
          HeartbeatGrpc.getMobileMethod = getMobileMethod =
              io.grpc.MethodDescriptor.<bilibili.api.player.v1.HeartbeatReq, bilibili.api.player.v1.HeartbeatReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Mobile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.api.player.v1.HeartbeatReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.api.player.v1.HeartbeatReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void mobile(bilibili.api.player.v1.HeartbeatReq request,
        io.grpc.stub.StreamObserver<bilibili.api.player.v1.HeartbeatReply> responseObserver) {
  ...
  public static final class HeartbeatStub
     ...
     * </pre>
     */
    public void mobile(bilibili.api.player.v1.HeartbeatReq request,
        io.grpc.stub.StreamObserver<bilibili.api.player.v1.HeartbeatReply> responseObserver) {
  ...
  public static final class HeartbeatBlockingStub
     ...
     * </pre>
     */
    public bilibili.api.player.v1.HeartbeatReply mobile(bilibili.api.player.v1.HeartbeatReq request) {
  ...
  public static final class HeartbeatFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.api.player.v1.HeartbeatReply> mobile(
        bilibili.api.player.v1.HeartbeatReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MOBILE:
          serviceImpl.mobile((bilibili.api.player.v1.HeartbeatReq) request,
              (io.grpc.stub.StreamObserver<bilibili.api.player.v1.HeartbeatReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HeartbeatBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.api.player.v1.Player.getDescriptor();
    }
