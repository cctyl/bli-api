...
public final class FissionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.account.fission.v1.EntranceReq,
      bilibili.account.fission.v1.EntranceReply> getEntranceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Entrance",
      requestType = bilibili.account.fission.v1.EntranceReq.class,
      responseType = bilibili.account.fission.v1.EntranceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.account.fission.v1.EntranceReq,
      bilibili.account.fission.v1.EntranceReply> getEntranceMethod() {
    io.grpc.MethodDescriptor<bilibili.account.fission.v1.EntranceReq, bilibili.account.fission.v1.EntranceReply> getEntranceMethod;
      ...
      synchronized (FissionGrpc.class) {
        if ((getEntranceMethod = FissionGrpc.getEntranceMethod) == null) {
          FissionGrpc.getEntranceMethod = getEntranceMethod =
              io.grpc.MethodDescriptor.<bilibili.account.fission.v1.EntranceReq, bilibili.account.fission.v1.EntranceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Entrance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.EntranceReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.EntranceReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.account.fission.v1.WindowReq,
      bilibili.account.fission.v1.WindowReply> getWindowMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Window",
      requestType = bilibili.account.fission.v1.WindowReq.class,
      responseType = bilibili.account.fission.v1.WindowReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.account.fission.v1.WindowReq,
      bilibili.account.fission.v1.WindowReply> getWindowMethod() {
    io.grpc.MethodDescriptor<bilibili.account.fission.v1.WindowReq, bilibili.account.fission.v1.WindowReply> getWindowMethod;
    if ((getWindowMethod = FissionGrpc.getWindowMethod) == null) {
      synchronized (FissionGrpc.class) {
        if ((getWindowMethod = FissionGrpc.getWindowMethod) == null) {
          FissionGrpc.getWindowMethod = getWindowMethod =
              io.grpc.MethodDescriptor.<bilibili.account.fission.v1.WindowReq, bilibili.account.fission.v1.WindowReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Window"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.WindowReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.WindowReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.account.fission.v1.PrivacyReq,
      bilibili.account.fission.v1.PrivacyReply> getPrivacyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Privacy",
      requestType = bilibili.account.fission.v1.PrivacyReq.class,
      responseType = bilibili.account.fission.v1.PrivacyReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.account.fission.v1.PrivacyReq,
      bilibili.account.fission.v1.PrivacyReply> getPrivacyMethod() {
    io.grpc.MethodDescriptor<bilibili.account.fission.v1.PrivacyReq, bilibili.account.fission.v1.PrivacyReply> getPrivacyMethod;
    if ((getPrivacyMethod = FissionGrpc.getPrivacyMethod) == null) {
      synchronized (FissionGrpc.class) {
        if ((getPrivacyMethod = FissionGrpc.getPrivacyMethod) == null) {
          FissionGrpc.getPrivacyMethod = getPrivacyMethod =
              io.grpc.MethodDescriptor.<bilibili.account.fission.v1.PrivacyReq, bilibili.account.fission.v1.PrivacyReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Privacy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.PrivacyReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.account.fission.v1.PrivacyReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void entrance(bilibili.account.fission.v1.EntranceReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.EntranceReply> responseObserver) {
     ...
     * </pre>
     */
    default void window(bilibili.account.fission.v1.WindowReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.WindowReply> responseObserver) {
     ...
     * </pre>
     */
    default void privacy(bilibili.account.fission.v1.PrivacyReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.PrivacyReply> responseObserver) {
  ...
  public static final class FissionStub
     ...
     * </pre>
     */
    public void entrance(bilibili.account.fission.v1.EntranceReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.EntranceReply> responseObserver) {
     ...
     * </pre>
     */
    public void window(bilibili.account.fission.v1.WindowReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.WindowReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
     ...
     * </pre>
     */
    public void privacy(bilibili.account.fission.v1.PrivacyReq request,
        io.grpc.stub.StreamObserver<bilibili.account.fission.v1.PrivacyReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class FissionBlockingStub
     ...
     * </pre>
     */
    public bilibili.account.fission.v1.EntranceReply entrance(bilibili.account.fission.v1.EntranceReq request) {
     ...
     * </pre>
     */
    public bilibili.account.fission.v1.WindowReply window(bilibili.account.fission.v1.WindowReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public bilibili.account.fission.v1.PrivacyReply privacy(bilibili.account.fission.v1.PrivacyReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class FissionFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.account.fission.v1.EntranceReply> entrance(
        bilibili.account.fission.v1.EntranceReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.account.fission.v1.WindowReply> window(
        bilibili.account.fission.v1.WindowReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.account.fission.v1.PrivacyReply> privacy(
        bilibili.account.fission.v1.PrivacyReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ENTRANCE:
          serviceImpl.entrance((bilibili.account.fission.v1.EntranceReq) request,
              (io.grpc.stub.StreamObserver<bilibili.account.fission.v1.EntranceReply>) responseObserver);
          break;
        case METHODID_WINDOW:
          serviceImpl.window((bilibili.account.fission.v1.WindowReq) request,
              (io.grpc.stub.StreamObserver<bilibili.account.fission.v1.WindowReply>) responseObserver);
          break;
        case METHODID_PRIVACY:
          serviceImpl.privacy((bilibili.account.fission.v1.PrivacyReq) request,
              (io.grpc.stub.StreamObserver<bilibili.account.fission.v1.PrivacyReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class FissionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.account.fission.v1.FissionOuterClass.getDescriptor();
    }
