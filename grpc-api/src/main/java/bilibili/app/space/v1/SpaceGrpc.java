...
public final class SpaceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.space.v1.ArchiveReq,
      bilibili.app.space.v1.ArchiveReply> getArchiveMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Archive",
      requestType = bilibili.app.space.v1.ArchiveReq.class,
      responseType = bilibili.app.space.v1.ArchiveReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.space.v1.ArchiveReq,
      bilibili.app.space.v1.ArchiveReply> getArchiveMethod() {
    io.grpc.MethodDescriptor<bilibili.app.space.v1.ArchiveReq, bilibili.app.space.v1.ArchiveReply> getArchiveMethod;
      ...
      synchronized (SpaceGrpc.class) {
        if ((getArchiveMethod = SpaceGrpc.getArchiveMethod) == null) {
          SpaceGrpc.getArchiveMethod = getArchiveMethod =
              io.grpc.MethodDescriptor.<bilibili.app.space.v1.ArchiveReq, bilibili.app.space.v1.ArchiveReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Archive"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.space.v1.ArchiveReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.space.v1.ArchiveReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void archive(bilibili.app.space.v1.ArchiveReq request,
        io.grpc.stub.StreamObserver<bilibili.app.space.v1.ArchiveReply> responseObserver) {
  ...
  public static final class SpaceStub
    ...
    /**
     */
    public void archive(bilibili.app.space.v1.ArchiveReq request,
        io.grpc.stub.StreamObserver<bilibili.app.space.v1.ArchiveReply> responseObserver) {
  ...
  public static final class SpaceBlockingStub
    ...
    /**
     */
    public bilibili.app.space.v1.ArchiveReply archive(bilibili.app.space.v1.ArchiveReq request) {
  ...
  public static final class SpaceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.space.v1.ArchiveReply> archive(
        bilibili.app.space.v1.ArchiveReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ARCHIVE:
          serviceImpl.archive((bilibili.app.space.v1.ArchiveReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.space.v1.ArchiveReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SpaceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.space.v1.SpaceOuterClass.getDescriptor();
    }
