...
public final class ViewGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq,
      bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> getViewMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "View",
      requestType = bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq.class,
      responseType = bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq,
      bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> getViewMethod() {
    io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq, bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> getViewMethod;
    if ((getViewMethod = ViewGrpc.getViewMethod) == null) {
      synchronized (ViewGrpc.class) {
        if ((getViewMethod = ViewGrpc.getViewMethod) == null) {
          ViewGrpc.getViewMethod = getViewMethod =
              io.grpc.MethodDescriptor.<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq, bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "View"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq,
      bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> getViewProgressMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ViewProgress",
      requestType = bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq.class,
      responseType = bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq,
      bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> getViewProgressMethod() {
    io.grpc.MethodDescriptor<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq, bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> getViewProgressMethod;
    if ((getViewProgressMethod = ViewGrpc.getViewProgressMethod) == null) {
      synchronized (ViewGrpc.class) {
        if ((getViewProgressMethod = ViewGrpc.getViewProgressMethod) == null) {
          ViewGrpc.getViewProgressMethod = getViewProgressMethod =
              io.grpc.MethodDescriptor.<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq, bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ViewProgress"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void view(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq request,
        io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> responseObserver) {
     ...
     * </pre>
     */
    default void viewProgress(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq request,
        io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> responseObserver) {
  ...
  public static final class ViewStub
     ...
     * </pre>
     */
    public void view(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq request,
        io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> responseObserver) {
     ...
     * </pre>
     */
    public void viewProgress(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq request,
        io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ViewBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply view(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq request) {
     ...
     * </pre>
     */
    public bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply viewProgress(bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ViewFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply> view(
        bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply> viewProgress(
        bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VIEW:
          serviceImpl.view((bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply>) responseObserver);
          break;
        case METHODID_VIEW_PROGRESS:
          serviceImpl.viewProgress((bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReq,
              bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewReply>(
                service, METHODID_VIEW)))
        .addMethod(
          getViewProgressMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReq,
              bilibili.app.viewunite.v1.ViewuniteRpcProto.ViewProgressReply>(
  ...
  private static abstract class ViewBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.viewunite.v1.ViewuniteRpcProto.getDescriptor();
    }
