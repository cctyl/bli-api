...
public final class TopicGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsAllReq,
      bilibili.app.topic.v1.TopicDetailsAllReply> getTopicDetailsAllMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TopicDetailsAll",
      requestType = bilibili.app.topic.v1.TopicDetailsAllReq.class,
      responseType = bilibili.app.topic.v1.TopicDetailsAllReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsAllReq,
      bilibili.app.topic.v1.TopicDetailsAllReply> getTopicDetailsAllMethod() {
    io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsAllReq, bilibili.app.topic.v1.TopicDetailsAllReply> getTopicDetailsAllMethod;
      ...
      synchronized (TopicGrpc.class) {
        if ((getTopicDetailsAllMethod = TopicGrpc.getTopicDetailsAllMethod) == null) {
          TopicGrpc.getTopicDetailsAllMethod = getTopicDetailsAllMethod =
              io.grpc.MethodDescriptor.<bilibili.app.topic.v1.TopicDetailsAllReq, bilibili.app.topic.v1.TopicDetailsAllReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TopicDetailsAll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicDetailsAllReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicDetailsAllReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsFoldReq,
      bilibili.app.topic.v1.TopicDetailsFoldReply> getTopicDetailsFoldMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TopicDetailsFold",
      requestType = bilibili.app.topic.v1.TopicDetailsFoldReq.class,
      responseType = bilibili.app.topic.v1.TopicDetailsFoldReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsFoldReq,
      bilibili.app.topic.v1.TopicDetailsFoldReply> getTopicDetailsFoldMethod() {
    io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicDetailsFoldReq, bilibili.app.topic.v1.TopicDetailsFoldReply> getTopicDetailsFoldMethod;
      ...
      synchronized (TopicGrpc.class) {
        if ((getTopicDetailsFoldMethod = TopicGrpc.getTopicDetailsFoldMethod) == null) {
          TopicGrpc.getTopicDetailsFoldMethod = getTopicDetailsFoldMethod =
              io.grpc.MethodDescriptor.<bilibili.app.topic.v1.TopicDetailsFoldReq, bilibili.app.topic.v1.TopicDetailsFoldReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TopicDetailsFold"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicDetailsFoldReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicDetailsFoldReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicSetDetailsReq,
      bilibili.app.topic.v1.TopicSetDetailsReply> getTopicSetDetailsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TopicSetDetails",
      requestType = bilibili.app.topic.v1.TopicSetDetailsReq.class,
      responseType = bilibili.app.topic.v1.TopicSetDetailsReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicSetDetailsReq,
      bilibili.app.topic.v1.TopicSetDetailsReply> getTopicSetDetailsMethod() {
    io.grpc.MethodDescriptor<bilibili.app.topic.v1.TopicSetDetailsReq, bilibili.app.topic.v1.TopicSetDetailsReply> getTopicSetDetailsMethod;
      ...
      synchronized (TopicGrpc.class) {
        if ((getTopicSetDetailsMethod = TopicGrpc.getTopicSetDetailsMethod) == null) {
          TopicGrpc.getTopicSetDetailsMethod = getTopicSetDetailsMethod =
              io.grpc.MethodDescriptor.<bilibili.app.topic.v1.TopicSetDetailsReq, bilibili.app.topic.v1.TopicSetDetailsReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TopicSetDetails"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicSetDetailsReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.topic.v1.TopicSetDetailsReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void topicDetailsAll(bilibili.app.topic.v1.TopicDetailsAllReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsAllReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTopicDetailsAllMethod(), responseObserver);
    }

    /**
     */
    default void topicDetailsFold(bilibili.app.topic.v1.TopicDetailsFoldReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsFoldReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTopicDetailsFoldMethod(), responseObserver);
    }

    /**
     */
    default void topicSetDetails(bilibili.app.topic.v1.TopicSetDetailsReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicSetDetailsReply> responseObserver) {
  ...
  public static final class TopicStub
    ...
    /**
     */
    public void topicDetailsAll(bilibili.app.topic.v1.TopicDetailsAllReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsAllReply> responseObserver) {
    ...
    /**
     */
    public void topicDetailsFold(bilibili.app.topic.v1.TopicDetailsFoldReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsFoldReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void topicSetDetails(bilibili.app.topic.v1.TopicSetDetailsReq request,
        io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicSetDetailsReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class TopicBlockingStub
    ...
    /**
     */
    public bilibili.app.topic.v1.TopicDetailsAllReply topicDetailsAll(bilibili.app.topic.v1.TopicDetailsAllReq request) {
    ...
    /**
     */
    public bilibili.app.topic.v1.TopicDetailsFoldReply topicDetailsFold(bilibili.app.topic.v1.TopicDetailsFoldReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public bilibili.app.topic.v1.TopicSetDetailsReply topicSetDetails(bilibili.app.topic.v1.TopicSetDetailsReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TopicFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.topic.v1.TopicDetailsAllReply> topicDetailsAll(
        bilibili.app.topic.v1.TopicDetailsAllReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.topic.v1.TopicDetailsFoldReply> topicDetailsFold(
        bilibili.app.topic.v1.TopicDetailsFoldReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.topic.v1.TopicSetDetailsReply> topicSetDetails(
        bilibili.app.topic.v1.TopicSetDetailsReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TOPIC_DETAILS_ALL:
          serviceImpl.topicDetailsAll((bilibili.app.topic.v1.TopicDetailsAllReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsAllReply>) responseObserver);
          break;
        case METHODID_TOPIC_DETAILS_FOLD:
          serviceImpl.topicDetailsFold((bilibili.app.topic.v1.TopicDetailsFoldReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicDetailsFoldReply>) responseObserver);
          break;
        case METHODID_TOPIC_SET_DETAILS:
          serviceImpl.topicSetDetails((bilibili.app.topic.v1.TopicSetDetailsReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.topic.v1.TopicSetDetailsReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TopicBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.topic.v1.TopicOuterClass.getDescriptor();
    }
