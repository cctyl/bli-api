...
public final class OpusGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq,
      bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> getOpusDetailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OpusDetail",
      requestType = bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq.class,
      responseType = bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq,
      bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> getOpusDetailMethod() {
    io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq, bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> getOpusDetailMethod;
      ...
      synchronized (OpusGrpc.class) {
        if ((getOpusDetailMethod = OpusGrpc.getOpusDetailMethod) == null) {
          OpusGrpc.getOpusDetailMethod = getOpusDetailMethod =
              io.grpc.MethodDescriptor.<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq, bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OpusDetail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void opusDetail(bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq request,
        io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> responseObserver) {
  ...
  public static final class OpusStub
     ...
     * </pre>
     */
    public void opusDetail(bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq request,
        io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> responseObserver) {
  ...
  public static final class OpusBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp opusDetail(bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq request) {
  ...
  public static final class OpusFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp> opusDetail(
        bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_OPUS_DETAIL:
          serviceImpl.opusDetail((bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailReq,
              bilibili.app.dynamic.v2.OpusRpcProto.OpusDetailResp>(
  ...
  private static abstract class OpusBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.dynamic.v2.OpusRpcProto.getDescriptor();
    }
