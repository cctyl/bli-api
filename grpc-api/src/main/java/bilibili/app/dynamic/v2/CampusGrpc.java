...
public final class CampusGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.WaterFlowRcmdReq,
      bilibili.app.dynamic.v2.WaterFlowRcmdResp> getWaterFlowRcmdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WaterFlowRcmd",
      requestType = bilibili.app.dynamic.v2.WaterFlowRcmdReq.class,
      responseType = bilibili.app.dynamic.v2.WaterFlowRcmdResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.WaterFlowRcmdReq,
      bilibili.app.dynamic.v2.WaterFlowRcmdResp> getWaterFlowRcmdMethod() {
    io.grpc.MethodDescriptor<bilibili.app.dynamic.v2.WaterFlowRcmdReq, bilibili.app.dynamic.v2.WaterFlowRcmdResp> getWaterFlowRcmdMethod;
      ...
      synchronized (CampusGrpc.class) {
        if ((getWaterFlowRcmdMethod = CampusGrpc.getWaterFlowRcmdMethod) == null) {
          CampusGrpc.getWaterFlowRcmdMethod = getWaterFlowRcmdMethod =
              io.grpc.MethodDescriptor.<bilibili.app.dynamic.v2.WaterFlowRcmdReq, bilibili.app.dynamic.v2.WaterFlowRcmdResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WaterFlowRcmd"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.dynamic.v2.WaterFlowRcmdReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.dynamic.v2.WaterFlowRcmdResp.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void waterFlowRcmd(bilibili.app.dynamic.v2.WaterFlowRcmdReq request,
        io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.WaterFlowRcmdResp> responseObserver) {
  ...
  public static final class CampusStub
     ...
     * </pre>
     */
    public void waterFlowRcmd(bilibili.app.dynamic.v2.WaterFlowRcmdReq request,
        io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.WaterFlowRcmdResp> responseObserver) {
  ...
  public static final class CampusBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.dynamic.v2.WaterFlowRcmdResp waterFlowRcmd(bilibili.app.dynamic.v2.WaterFlowRcmdReq request) {
  ...
  public static final class CampusFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.dynamic.v2.WaterFlowRcmdResp> waterFlowRcmd(
        bilibili.app.dynamic.v2.WaterFlowRcmdReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WATER_FLOW_RCMD:
          serviceImpl.waterFlowRcmd((bilibili.app.dynamic.v2.WaterFlowRcmdReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.dynamic.v2.WaterFlowRcmdResp>) responseObserver);
          break;
        default:
