...
public interface ModuleLikeUserOrBuilder extends
   ...
   */
  java.util.List<bilibili.app.dynamic.v2.LikeUser> 
      getLikeUsersList();
  /**
   * <pre>
   * 点赞用户
   ...
   * <code>repeated .bilibili.app.dynamic.v2.LikeUser like_users = 1;</code>
   */
  bilibili.app.dynamic.v2.LikeUser getLikeUsers(int index);
  /**
   * <pre>
   * 点赞用户
   * </pre>
   ...
   * <code>repeated .bilibili.app.dynamic.v2.LikeUser like_users = 1;</code>
   */
  java.util.List<? extends bilibili.app.dynamic.v2.LikeUserOrBuilder> 
   ...
   * <code>repeated .bilibili.app.dynamic.v2.LikeUser like_users = 1;</code>
   */
  bilibili.app.dynamic.v2.LikeUserOrBuilder getLikeUsersOrBuilder(
      int index);
