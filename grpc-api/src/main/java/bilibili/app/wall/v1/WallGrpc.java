...
public final class WallGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.wall.v1.RuleRequest,
      bilibili.app.wall.v1.RulesReply> getRuleInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RuleInfo",
      requestType = bilibili.app.wall.v1.RuleRequest.class,
      responseType = bilibili.app.wall.v1.RulesReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.wall.v1.RuleRequest,
      bilibili.app.wall.v1.RulesReply> getRuleInfoMethod() {
    io.grpc.MethodDescriptor<bilibili.app.wall.v1.RuleRequest, bilibili.app.wall.v1.RulesReply> getRuleInfoMethod;
      ...
      synchronized (WallGrpc.class) {
        if ((getRuleInfoMethod = WallGrpc.getRuleInfoMethod) == null) {
          WallGrpc.getRuleInfoMethod = getRuleInfoMethod =
              io.grpc.MethodDescriptor.<bilibili.app.wall.v1.RuleRequest, bilibili.app.wall.v1.RulesReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RuleInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.wall.v1.RuleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.wall.v1.RulesReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void ruleInfo(bilibili.app.wall.v1.RuleRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.wall.v1.RulesReply> responseObserver) {
  ...
  public static final class WallStub
     ...
     * </pre>
     */
    public void ruleInfo(bilibili.app.wall.v1.RuleRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.wall.v1.RulesReply> responseObserver) {
  ...
  public static final class WallBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.wall.v1.RulesReply ruleInfo(bilibili.app.wall.v1.RuleRequest request) {
  ...
  public static final class WallFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.wall.v1.RulesReply> ruleInfo(
        bilibili.app.wall.v1.RuleRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RULE_INFO:
          serviceImpl.ruleInfo((bilibili.app.wall.v1.RuleRequest) request,
              (io.grpc.stub.StreamObserver<bilibili.app.wall.v1.RulesReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class WallBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.wall.v1.WallOuterClass.getDescriptor();
    }
