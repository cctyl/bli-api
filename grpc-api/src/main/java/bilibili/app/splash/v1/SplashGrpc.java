...
public final class SplashGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.splash.v1.SplashReq,
      bilibili.app.splash.v1.SplashReply> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "List",
      requestType = bilibili.app.splash.v1.SplashReq.class,
      responseType = bilibili.app.splash.v1.SplashReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.splash.v1.SplashReq,
      bilibili.app.splash.v1.SplashReply> getListMethod() {
    io.grpc.MethodDescriptor<bilibili.app.splash.v1.SplashReq, bilibili.app.splash.v1.SplashReply> getListMethod;
    if ((getListMethod = SplashGrpc.getListMethod) == null) {
      synchronized (SplashGrpc.class) {
        if ((getListMethod = SplashGrpc.getListMethod) == null) {
          SplashGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<bilibili.app.splash.v1.SplashReq, bilibili.app.splash.v1.SplashReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "List"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.splash.v1.SplashReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.splash.v1.SplashReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void list(bilibili.app.splash.v1.SplashReq request,
        io.grpc.stub.StreamObserver<bilibili.app.splash.v1.SplashReply> responseObserver) {
  ...
  public static final class SplashStub
    ...
    /**
     */
    public void list(bilibili.app.splash.v1.SplashReq request,
        io.grpc.stub.StreamObserver<bilibili.app.splash.v1.SplashReply> responseObserver) {
  ...
  public static final class SplashBlockingStub
    ...
    /**
     */
    public bilibili.app.splash.v1.SplashReply list(bilibili.app.splash.v1.SplashReq request) {
  ...
  public static final class SplashFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.splash.v1.SplashReply> list(
        bilibili.app.splash.v1.SplashReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((bilibili.app.splash.v1.SplashReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.splash.v1.SplashReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SplashBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.splash.v1.SplashOuterClass.getDescriptor();
    }
