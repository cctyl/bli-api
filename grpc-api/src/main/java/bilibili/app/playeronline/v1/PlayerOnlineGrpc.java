...
public final class PlayerOnlineGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PlayerOnlineReq,
      bilibili.app.playeronline.v1.PlayerOnlineReply> getPlayerOnlineMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlayerOnline",
      requestType = bilibili.app.playeronline.v1.PlayerOnlineReq.class,
      responseType = bilibili.app.playeronline.v1.PlayerOnlineReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PlayerOnlineReq,
      bilibili.app.playeronline.v1.PlayerOnlineReply> getPlayerOnlineMethod() {
    io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PlayerOnlineReq, bilibili.app.playeronline.v1.PlayerOnlineReply> getPlayerOnlineMethod;
      ...
      synchronized (PlayerOnlineGrpc.class) {
        if ((getPlayerOnlineMethod = PlayerOnlineGrpc.getPlayerOnlineMethod) == null) {
          PlayerOnlineGrpc.getPlayerOnlineMethod = getPlayerOnlineMethod =
              io.grpc.MethodDescriptor.<bilibili.app.playeronline.v1.PlayerOnlineReq, bilibili.app.playeronline.v1.PlayerOnlineReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlayerOnline"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.PlayerOnlineReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.PlayerOnlineReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PremiereInfoReq,
      bilibili.app.playeronline.v1.PremiereInfoReply> getPremiereInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PremiereInfo",
      requestType = bilibili.app.playeronline.v1.PremiereInfoReq.class,
      responseType = bilibili.app.playeronline.v1.PremiereInfoReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PremiereInfoReq,
      bilibili.app.playeronline.v1.PremiereInfoReply> getPremiereInfoMethod() {
    io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.PremiereInfoReq, bilibili.app.playeronline.v1.PremiereInfoReply> getPremiereInfoMethod;
      ...
      synchronized (PlayerOnlineGrpc.class) {
        if ((getPremiereInfoMethod = PlayerOnlineGrpc.getPremiereInfoMethod) == null) {
          PlayerOnlineGrpc.getPremiereInfoMethod = getPremiereInfoMethod =
              io.grpc.MethodDescriptor.<bilibili.app.playeronline.v1.PremiereInfoReq, bilibili.app.playeronline.v1.PremiereInfoReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PremiereInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.PremiereInfoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.PremiereInfoReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.ReportWatchReq,
      bilibili.app.playeronline.v1.NoReply> getReportWatchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReportWatch",
      requestType = bilibili.app.playeronline.v1.ReportWatchReq.class,
      responseType = bilibili.app.playeronline.v1.NoReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.ReportWatchReq,
      bilibili.app.playeronline.v1.NoReply> getReportWatchMethod() {
    io.grpc.MethodDescriptor<bilibili.app.playeronline.v1.ReportWatchReq, bilibili.app.playeronline.v1.NoReply> getReportWatchMethod;
      ...
      synchronized (PlayerOnlineGrpc.class) {
        if ((getReportWatchMethod = PlayerOnlineGrpc.getReportWatchMethod) == null) {
          PlayerOnlineGrpc.getReportWatchMethod = getReportWatchMethod =
              io.grpc.MethodDescriptor.<bilibili.app.playeronline.v1.ReportWatchReq, bilibili.app.playeronline.v1.NoReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReportWatch"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.ReportWatchReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playeronline.v1.NoReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void playerOnline(bilibili.app.playeronline.v1.PlayerOnlineReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PlayerOnlineReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPlayerOnlineMethod(), responseObserver);
    }

    /**
     */
    default void premiereInfo(bilibili.app.playeronline.v1.PremiereInfoReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PremiereInfoReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPremiereInfoMethod(), responseObserver);
    }

    /**
     */
    default void reportWatch(bilibili.app.playeronline.v1.ReportWatchReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.NoReply> responseObserver) {
  ...
  public static final class PlayerOnlineStub
     ...
     * </pre>
     */
    public void playerOnline(bilibili.app.playeronline.v1.PlayerOnlineReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PlayerOnlineReply> responseObserver) {
    ...
    /**
     */
    public void premiereInfo(bilibili.app.playeronline.v1.PremiereInfoReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PremiereInfoReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void reportWatch(bilibili.app.playeronline.v1.ReportWatchReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.NoReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PlayerOnlineBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.playeronline.v1.PlayerOnlineReply playerOnline(bilibili.app.playeronline.v1.PlayerOnlineReq request) {
    ...
    /**
     */
    public bilibili.app.playeronline.v1.PremiereInfoReply premiereInfo(bilibili.app.playeronline.v1.PremiereInfoReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public bilibili.app.playeronline.v1.NoReply reportWatch(bilibili.app.playeronline.v1.ReportWatchReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PlayerOnlineFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.playeronline.v1.PlayerOnlineReply> playerOnline(
        bilibili.app.playeronline.v1.PlayerOnlineReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.playeronline.v1.PremiereInfoReply> premiereInfo(
        bilibili.app.playeronline.v1.PremiereInfoReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.playeronline.v1.NoReply> reportWatch(
        bilibili.app.playeronline.v1.ReportWatchReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLAYER_ONLINE:
          serviceImpl.playerOnline((bilibili.app.playeronline.v1.PlayerOnlineReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PlayerOnlineReply>) responseObserver);
          break;
        case METHODID_PREMIERE_INFO:
          serviceImpl.premiereInfo((bilibili.app.playeronline.v1.PremiereInfoReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.PremiereInfoReply>) responseObserver);
          break;
        case METHODID_REPORT_WATCH:
          serviceImpl.reportWatch((bilibili.app.playeronline.v1.ReportWatchReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.playeronline.v1.NoReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class PlayerOnlineBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.playeronline.v1.Playeronline.getDescriptor();
    }
