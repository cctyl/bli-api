...
public final class AppShowGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq,
      bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> getGetActProgressMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetActProgress",
      requestType = bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq.class,
      responseType = bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq,
      bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> getGetActProgressMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq, bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> getGetActProgressMethod;
      ...
      synchronized (AppShowGrpc.class) {
        if ((getGetActProgressMethod = AppShowGrpc.getGetActProgressMethod) == null) {
          AppShowGrpc.getGetActProgressMethod = getGetActProgressMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq, bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetActProgress"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getActProgress(bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> responseObserver) {
  ...
  public static final class AppShowStub
     ...
     * </pre>
     */
    public void getActProgress(bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> responseObserver) {
  ...
  public static final class AppShowBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply getActProgress(bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq request) {
  ...
  public static final class AppShowFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply> getActProgress(
        bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACT_PROGRESS:
          serviceImpl.getActProgress((bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReq,
              bilibili.app.show.gateway.v1.ServiceRpcProto.GetActProgressReply>(
  ...
  private static abstract class AppShowBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.show.gateway.v1.ServiceRpcProto.getDescriptor();
    }
