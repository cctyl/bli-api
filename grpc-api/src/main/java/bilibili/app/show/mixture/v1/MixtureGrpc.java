...
public final class MixtureGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.mixture.v1.WidgetReq,
      bilibili.app.show.mixture.v1.WidgetReply> getWidgetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Widget",
      requestType = bilibili.app.show.mixture.v1.WidgetReq.class,
      responseType = bilibili.app.show.mixture.v1.WidgetReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.mixture.v1.WidgetReq,
      bilibili.app.show.mixture.v1.WidgetReply> getWidgetMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.mixture.v1.WidgetReq, bilibili.app.show.mixture.v1.WidgetReply> getWidgetMethod;
      ...
      synchronized (MixtureGrpc.class) {
        if ((getWidgetMethod = MixtureGrpc.getWidgetMethod) == null) {
          MixtureGrpc.getWidgetMethod = getWidgetMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.mixture.v1.WidgetReq, bilibili.app.show.mixture.v1.WidgetReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Widget"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.mixture.v1.WidgetReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.mixture.v1.WidgetReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void widget(bilibili.app.show.mixture.v1.WidgetReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.mixture.v1.WidgetReply> responseObserver) {
  ...
  public static final class MixtureStub
     ...
     * </pre>
     */
    public void widget(bilibili.app.show.mixture.v1.WidgetReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.mixture.v1.WidgetReply> responseObserver) {
  ...
  public static final class MixtureBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.show.mixture.v1.WidgetReply widget(bilibili.app.show.mixture.v1.WidgetReq request) {
  ...
  public static final class MixtureFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.mixture.v1.WidgetReply> widget(
        bilibili.app.show.mixture.v1.WidgetReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WIDGET:
          serviceImpl.widget((bilibili.app.show.mixture.v1.WidgetReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.mixture.v1.WidgetReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MixtureBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.show.mixture.v1.MixtureOuterClass.getDescriptor();
    }
