...
public final class PopularGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.v1.PopularRpcProto.PopularResultReq,
      bilibili.app.show.v1.PopularRpcProto.PopularReply> getIndexMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Index",
      requestType = bilibili.app.show.v1.PopularRpcProto.PopularResultReq.class,
      responseType = bilibili.app.show.v1.PopularRpcProto.PopularReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.v1.PopularRpcProto.PopularResultReq,
      bilibili.app.show.v1.PopularRpcProto.PopularReply> getIndexMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.v1.PopularRpcProto.PopularResultReq, bilibili.app.show.v1.PopularRpcProto.PopularReply> getIndexMethod;
    if ((getIndexMethod = PopularGrpc.getIndexMethod) == null) {
      synchronized (PopularGrpc.class) {
        if ((getIndexMethod = PopularGrpc.getIndexMethod) == null) {
          PopularGrpc.getIndexMethod = getIndexMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.v1.PopularRpcProto.PopularResultReq, bilibili.app.show.v1.PopularRpcProto.PopularReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Index"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.PopularRpcProto.PopularResultReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.PopularRpcProto.PopularReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void index(bilibili.app.show.v1.PopularRpcProto.PopularResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.PopularRpcProto.PopularReply> responseObserver) {
  ...
  public static final class PopularStub
     ...
     * </pre>
     */
    public void index(bilibili.app.show.v1.PopularRpcProto.PopularResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.PopularRpcProto.PopularReply> responseObserver) {
  ...
  public static final class PopularBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.show.v1.PopularRpcProto.PopularReply index(bilibili.app.show.v1.PopularRpcProto.PopularResultReq request) {
  ...
  public static final class PopularFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.v1.PopularRpcProto.PopularReply> index(
        bilibili.app.show.v1.PopularRpcProto.PopularResultReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_INDEX:
          serviceImpl.index((bilibili.app.show.v1.PopularRpcProto.PopularResultReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.v1.PopularRpcProto.PopularReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.show.v1.PopularRpcProto.PopularResultReq,
              bilibili.app.show.v1.PopularRpcProto.PopularReply>(
  ...
  private static abstract class PopularBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.show.v1.PopularRpcProto.getDescriptor();
    }
