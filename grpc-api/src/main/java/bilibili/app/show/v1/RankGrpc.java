...
public final class RankGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.v1.RankAllResultReq,
      bilibili.app.show.v1.RankListReply> getRankAllMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RankAll",
      requestType = bilibili.app.show.v1.RankAllResultReq.class,
      responseType = bilibili.app.show.v1.RankListReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.v1.RankAllResultReq,
      bilibili.app.show.v1.RankListReply> getRankAllMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.v1.RankAllResultReq, bilibili.app.show.v1.RankListReply> getRankAllMethod;
    if ((getRankAllMethod = RankGrpc.getRankAllMethod) == null) {
      synchronized (RankGrpc.class) {
        if ((getRankAllMethod = RankGrpc.getRankAllMethod) == null) {
          RankGrpc.getRankAllMethod = getRankAllMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.v1.RankAllResultReq, bilibili.app.show.v1.RankListReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RankAll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.RankAllResultReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.RankListReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.v1.RankRegionResultReq,
      bilibili.app.show.v1.RankListReply> getRankRegionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RankRegion",
      requestType = bilibili.app.show.v1.RankRegionResultReq.class,
      responseType = bilibili.app.show.v1.RankListReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.v1.RankRegionResultReq,
      bilibili.app.show.v1.RankListReply> getRankRegionMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.v1.RankRegionResultReq, bilibili.app.show.v1.RankListReply> getRankRegionMethod;
    if ((getRankRegionMethod = RankGrpc.getRankRegionMethod) == null) {
      synchronized (RankGrpc.class) {
        if ((getRankRegionMethod = RankGrpc.getRankRegionMethod) == null) {
          RankGrpc.getRankRegionMethod = getRankRegionMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.v1.RankRegionResultReq, bilibili.app.show.v1.RankListReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RankRegion"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.RankRegionResultReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.v1.RankListReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void rankAll(bilibili.app.show.v1.RankAllResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply> responseObserver) {
     ...
     * </pre>
     */
    default void rankRegion(bilibili.app.show.v1.RankRegionResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply> responseObserver) {
  ...
  public static final class RankStub
     ...
     * </pre>
     */
    public void rankAll(bilibili.app.show.v1.RankAllResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply> responseObserver) {
     ...
     * </pre>
     */
    public void rankRegion(bilibili.app.show.v1.RankRegionResultReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class RankBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.show.v1.RankListReply rankAll(bilibili.app.show.v1.RankAllResultReq request) {
     ...
     * </pre>
     */
    public bilibili.app.show.v1.RankListReply rankRegion(bilibili.app.show.v1.RankRegionResultReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RankFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.v1.RankListReply> rankAll(
        bilibili.app.show.v1.RankAllResultReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.v1.RankListReply> rankRegion(
        bilibili.app.show.v1.RankRegionResultReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RANK_ALL:
          serviceImpl.rankAll((bilibili.app.show.v1.RankAllResultReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply>) responseObserver);
          break;
        case METHODID_RANK_REGION:
          serviceImpl.rankRegion((bilibili.app.show.v1.RankRegionResultReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.v1.RankListReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class RankBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.show.v1.RankOuterClass.getDescriptor();
    }
