...
public final class RegionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.show.region.v1.RegionReq,
      bilibili.app.show.region.v1.RegionReply> getRegionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Region",
      requestType = bilibili.app.show.region.v1.RegionReq.class,
      responseType = bilibili.app.show.region.v1.RegionReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.show.region.v1.RegionReq,
      bilibili.app.show.region.v1.RegionReply> getRegionMethod() {
    io.grpc.MethodDescriptor<bilibili.app.show.region.v1.RegionReq, bilibili.app.show.region.v1.RegionReply> getRegionMethod;
      ...
      synchronized (RegionGrpc.class) {
        if ((getRegionMethod = RegionGrpc.getRegionMethod) == null) {
          RegionGrpc.getRegionMethod = getRegionMethod =
              io.grpc.MethodDescriptor.<bilibili.app.show.region.v1.RegionReq, bilibili.app.show.region.v1.RegionReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Region"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.region.v1.RegionReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.show.region.v1.RegionReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void region(bilibili.app.show.region.v1.RegionReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.region.v1.RegionReply> responseObserver) {
  ...
  public static final class RegionStub
    ...
    /**
     */
    public void region(bilibili.app.show.region.v1.RegionReq request,
        io.grpc.stub.StreamObserver<bilibili.app.show.region.v1.RegionReply> responseObserver) {
  ...
  public static final class RegionBlockingStub
    ...
    /**
     */
    public bilibili.app.show.region.v1.RegionReply region(bilibili.app.show.region.v1.RegionReq request) {
  ...
  public static final class RegionFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.show.region.v1.RegionReply> region(
        bilibili.app.show.region.v1.RegionReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGION:
          serviceImpl.region((bilibili.app.show.region.v1.RegionReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.show.region.v1.RegionReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class RegionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.show.region.v1.RegionOuterClass.getDescriptor();
    }
