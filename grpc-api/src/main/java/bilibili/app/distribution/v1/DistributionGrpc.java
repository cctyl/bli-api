...
public final class DistributionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.distribution.v1.GetUserPreferenceReq,
      bilibili.app.distribution.v1.GetUserPreferenceReply> getGetUserPreferenceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserPreference",
      requestType = bilibili.app.distribution.v1.GetUserPreferenceReq.class,
      responseType = bilibili.app.distribution.v1.GetUserPreferenceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.distribution.v1.GetUserPreferenceReq,
      bilibili.app.distribution.v1.GetUserPreferenceReply> getGetUserPreferenceMethod() {
    io.grpc.MethodDescriptor<bilibili.app.distribution.v1.GetUserPreferenceReq, bilibili.app.distribution.v1.GetUserPreferenceReply> getGetUserPreferenceMethod;
      ...
      synchronized (DistributionGrpc.class) {
        if ((getGetUserPreferenceMethod = DistributionGrpc.getGetUserPreferenceMethod) == null) {
          DistributionGrpc.getGetUserPreferenceMethod = getGetUserPreferenceMethod =
              io.grpc.MethodDescriptor.<bilibili.app.distribution.v1.GetUserPreferenceReq, bilibili.app.distribution.v1.GetUserPreferenceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUserPreference"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.GetUserPreferenceReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.GetUserPreferenceReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.distribution.v1.SetUserPreferenceReq,
      bilibili.app.distribution.v1.SetUserPreferenceReply> getSetUserPreferenceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetUserPreference",
      requestType = bilibili.app.distribution.v1.SetUserPreferenceReq.class,
      responseType = bilibili.app.distribution.v1.SetUserPreferenceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.distribution.v1.SetUserPreferenceReq,
      bilibili.app.distribution.v1.SetUserPreferenceReply> getSetUserPreferenceMethod() {
    io.grpc.MethodDescriptor<bilibili.app.distribution.v1.SetUserPreferenceReq, bilibili.app.distribution.v1.SetUserPreferenceReply> getSetUserPreferenceMethod;
      ...
      synchronized (DistributionGrpc.class) {
        if ((getSetUserPreferenceMethod = DistributionGrpc.getSetUserPreferenceMethod) == null) {
          DistributionGrpc.getSetUserPreferenceMethod = getSetUserPreferenceMethod =
              io.grpc.MethodDescriptor.<bilibili.app.distribution.v1.SetUserPreferenceReq, bilibili.app.distribution.v1.SetUserPreferenceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SetUserPreference"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.SetUserPreferenceReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.SetUserPreferenceReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.distribution.v1.UserPreferenceReq,
      bilibili.app.distribution.v1.UserPreferenceReply> getUserPreferenceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UserPreference",
      requestType = bilibili.app.distribution.v1.UserPreferenceReq.class,
      responseType = bilibili.app.distribution.v1.UserPreferenceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.distribution.v1.UserPreferenceReq,
      bilibili.app.distribution.v1.UserPreferenceReply> getUserPreferenceMethod() {
    io.grpc.MethodDescriptor<bilibili.app.distribution.v1.UserPreferenceReq, bilibili.app.distribution.v1.UserPreferenceReply> getUserPreferenceMethod;
      ...
      synchronized (DistributionGrpc.class) {
        if ((getUserPreferenceMethod = DistributionGrpc.getUserPreferenceMethod) == null) {
          DistributionGrpc.getUserPreferenceMethod = getUserPreferenceMethod =
              io.grpc.MethodDescriptor.<bilibili.app.distribution.v1.UserPreferenceReq, bilibili.app.distribution.v1.UserPreferenceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UserPreference"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.UserPreferenceReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.distribution.v1.UserPreferenceReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getUserPreference(bilibili.app.distribution.v1.GetUserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.GetUserPreferenceReply> responseObserver) {
     ...
     * </pre>
     */
    default void setUserPreference(bilibili.app.distribution.v1.SetUserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.SetUserPreferenceReply> responseObserver) {
     ...
     * </pre>
     */
    default void userPreference(bilibili.app.distribution.v1.UserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.UserPreferenceReply> responseObserver) {
  ...
  public static final class DistributionStub
     ...
     * </pre>
     */
    public void getUserPreference(bilibili.app.distribution.v1.GetUserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.GetUserPreferenceReply> responseObserver) {
     ...
     * </pre>
     */
    public void setUserPreference(bilibili.app.distribution.v1.SetUserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.SetUserPreferenceReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
     ...
     * </pre>
     */
    public void userPreference(bilibili.app.distribution.v1.UserPreferenceReq request,
        io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.UserPreferenceReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class DistributionBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.distribution.v1.GetUserPreferenceReply getUserPreference(bilibili.app.distribution.v1.GetUserPreferenceReq request) {
     ...
     * </pre>
     */
    public bilibili.app.distribution.v1.SetUserPreferenceReply setUserPreference(bilibili.app.distribution.v1.SetUserPreferenceReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public bilibili.app.distribution.v1.UserPreferenceReply userPreference(bilibili.app.distribution.v1.UserPreferenceReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class DistributionFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.distribution.v1.GetUserPreferenceReply> getUserPreference(
        bilibili.app.distribution.v1.GetUserPreferenceReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.distribution.v1.SetUserPreferenceReply> setUserPreference(
        bilibili.app.distribution.v1.SetUserPreferenceReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.distribution.v1.UserPreferenceReply> userPreference(
        bilibili.app.distribution.v1.UserPreferenceReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_PREFERENCE:
          serviceImpl.getUserPreference((bilibili.app.distribution.v1.GetUserPreferenceReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.GetUserPreferenceReply>) responseObserver);
          break;
        case METHODID_SET_USER_PREFERENCE:
          serviceImpl.setUserPreference((bilibili.app.distribution.v1.SetUserPreferenceReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.SetUserPreferenceReply>) responseObserver);
          break;
        case METHODID_USER_PREFERENCE:
          serviceImpl.userPreference((bilibili.app.distribution.v1.UserPreferenceReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.distribution.v1.UserPreferenceReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class DistributionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.distribution.v1.DistributionOuterClass.getDescriptor();
    }
