...
public final class PlayerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq,
      bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> getPlayViewUniteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PlayViewUnite",
      requestType = bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq.class,
      responseType = bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq,
      bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> getPlayViewUniteMethod() {
    io.grpc.MethodDescriptor<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq, bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> getPlayViewUniteMethod;
      ...
      synchronized (PlayerGrpc.class) {
        if ((getPlayViewUniteMethod = PlayerGrpc.getPlayViewUniteMethod) == null) {
          PlayerGrpc.getPlayViewUniteMethod = getPlayViewUniteMethod =
              io.grpc.MethodDescriptor.<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq, bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PlayViewUnite"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void playViewUnite(bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> responseObserver) {
  ...
  public static final class PlayerStub
     ...
     * </pre>
     */
    public void playViewUnite(bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq request,
        io.grpc.stub.StreamObserver<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> responseObserver) {
  ...
  public static final class PlayerBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply playViewUnite(bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq request) {
  ...
  public static final class PlayerFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply> playViewUnite(
        bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PLAY_VIEW_UNITE:
          serviceImpl.playViewUnite((bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReq,
              bilibili.app.playerunite.v1.PlayeruniteRpcProto.PlayViewUniteReply>(
  ...
  private static abstract class PlayerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.playerunite.v1.PlayeruniteRpcProto.getDescriptor();
    }
