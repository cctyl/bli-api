...
public final class ModuleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.resource.v1.ModuleRpcProto.ListReq,
      bilibili.app.resource.v1.ModuleRpcProto.ListReply> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "List",
      requestType = bilibili.app.resource.v1.ModuleRpcProto.ListReq.class,
      responseType = bilibili.app.resource.v1.ModuleRpcProto.ListReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.resource.v1.ModuleRpcProto.ListReq,
      bilibili.app.resource.v1.ModuleRpcProto.ListReply> getListMethod() {
    io.grpc.MethodDescriptor<bilibili.app.resource.v1.ModuleRpcProto.ListReq, bilibili.app.resource.v1.ModuleRpcProto.ListReply> getListMethod;
    if ((getListMethod = ModuleGrpc.getListMethod) == null) {
      synchronized (ModuleGrpc.class) {
        if ((getListMethod = ModuleGrpc.getListMethod) == null) {
          ModuleGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<bilibili.app.resource.v1.ModuleRpcProto.ListReq, bilibili.app.resource.v1.ModuleRpcProto.ListReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "List"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.v1.ModuleRpcProto.ListReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.v1.ModuleRpcProto.ListReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void list(bilibili.app.resource.v1.ModuleRpcProto.ListReq request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.v1.ModuleRpcProto.ListReply> responseObserver) {
  ...
  public static final class ModuleStub
    ...
    /**
     */
    public void list(bilibili.app.resource.v1.ModuleRpcProto.ListReq request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.v1.ModuleRpcProto.ListReply> responseObserver) {
  ...
  public static final class ModuleBlockingStub
    ...
    /**
     */
    public bilibili.app.resource.v1.ModuleRpcProto.ListReply list(bilibili.app.resource.v1.ModuleRpcProto.ListReq request) {
  ...
  public static final class ModuleFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.resource.v1.ModuleRpcProto.ListReply> list(
        bilibili.app.resource.v1.ModuleRpcProto.ListReq request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((bilibili.app.resource.v1.ModuleRpcProto.ListReq) request,
              (io.grpc.stub.StreamObserver<bilibili.app.resource.v1.ModuleRpcProto.ListReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.resource.v1.ModuleRpcProto.ListReq,
              bilibili.app.resource.v1.ModuleRpcProto.ListReply>(
  ...
  private static abstract class ModuleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.resource.v1.ModuleRpcProto.getDescriptor();
    }
