...
public final class PrivacyGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest,
      bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> getPrivacyConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PrivacyConfig",
      requestType = bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest.class,
      responseType = bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest,
      bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> getPrivacyConfigMethod() {
    io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest, bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> getPrivacyConfigMethod;
      ...
      synchronized (PrivacyGrpc.class) {
        if ((getPrivacyConfigMethod = PrivacyGrpc.getPrivacyConfigMethod) == null) {
          PrivacyGrpc.getPrivacyConfigMethod = getPrivacyConfigMethod =
              io.grpc.MethodDescriptor.<bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest, bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PrivacyConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest,
      bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> getSetPrivacyConfigMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetPrivacyConfig",
      requestType = bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest.class,
      responseType = bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest,
      bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> getSetPrivacyConfigMethod() {
    io.grpc.MethodDescriptor<bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest, bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> getSetPrivacyConfigMethod;
      ...
      synchronized (PrivacyGrpc.class) {
        if ((getSetPrivacyConfigMethod = PrivacyGrpc.getSetPrivacyConfigMethod) == null) {
          PrivacyGrpc.getSetPrivacyConfigMethod = getSetPrivacyConfigMethod =
              io.grpc.MethodDescriptor.<bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest, bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SetPrivacyConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void privacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> responseObserver) {
     ...
     * </pre>
     */
    default void setPrivacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> responseObserver) {
  ...
  public static final class PrivacyStub
     ...
     * </pre>
     */
    public void privacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> responseObserver) {
     ...
     * </pre>
     */
    public void setPrivacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest request,
        io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PrivacyBlockingStub
     ...
     * </pre>
     */
    public bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply privacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest request) {
     ...
     * </pre>
     */
    public bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply setPrivacyConfig(bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PrivacyFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply> privacyConfig(
        bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply> setPrivacyConfig(
        bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PRIVACY_CONFIG:
          serviceImpl.privacyConfig((bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest) request,
              (io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply>) responseObserver);
          break;
        case METHODID_SET_PRIVACY_CONFIG:
          serviceImpl.setPrivacyConfig((bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest) request,
              (io.grpc.stub.StreamObserver<bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.resource.privacy.v1.ApiRpcProto.NoArgRequest,
              bilibili.app.resource.privacy.v1.ApiRpcProto.PrivacyConfigReply>(
                service, METHODID_PRIVACY_CONFIG)))
        .addMethod(
          getSetPrivacyConfigMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.app.resource.privacy.v1.ApiRpcProto.SetPrivacyConfigRequest,
              bilibili.app.resource.privacy.v1.ApiRpcProto.NoReply>(
  ...
  private static abstract class PrivacyBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.app.resource.privacy.v1.ApiRpcProto.getDescriptor();
    }
