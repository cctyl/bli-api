...
public final class RelationInterfaceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "bilibili.relation.interfaces.v1.RelationInterface";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq,
      bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> getAtSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AtSearch",
      requestType = bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq.class,
      responseType = bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq,
      bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> getAtSearchMethod() {
    io.grpc.MethodDescriptor<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq, bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> getAtSearchMethod;
      ...
      synchronized (RelationInterfaceGrpc.class) {
        if ((getAtSearchMethod = RelationInterfaceGrpc.getAtSearchMethod) == null) {
          RelationInterfaceGrpc.getAtSearchMethod = getAtSearchMethod =
              io.grpc.MethodDescriptor.<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq, bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AtSearch"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void atSearch(bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq request,
        io.grpc.stub.StreamObserver<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> responseObserver) {
  ...
  public static final class RelationInterfaceStub
     ...
     * </pre>
     */
    public void atSearch(bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq request,
        io.grpc.stub.StreamObserver<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> responseObserver) {
  ...
  public static final class RelationInterfaceBlockingStub
     ...
     * </pre>
     */
    public bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply atSearch(bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq request) {
  ...
  public static final class RelationInterfaceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply> atSearch(
        bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AT_SEARCH:
          serviceImpl.atSearch((bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq) request,
              (io.grpc.stub.StreamObserver<bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReq,
              bilibili.relation.interfaces.v1.ApiRpcProto.AtSearchReply>(
  ...
  private static abstract class RelationInterfaceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bilibili.relation.interfaces.v1.ApiRpcProto.getDescriptor();
    }
